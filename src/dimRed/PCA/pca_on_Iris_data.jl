using MultivariateStats, RDatasets, Plots, PyPlot
...
#scatter!(versicolor[1,:],versicolor[2,:],versicolor[3,:],marker=:circle,linewidth=0)
#scatter!(virginica[1,:],virginica[2,:],virginica[3,:],marker=:circle,linewidth=0)
Plots.plot!(r,xlabel="PC1",ylabel="PC2",zlabel="PC3", legend=false)
#PyPlot.title("PCA projection onto the first 3 PCs")
savefig("PCA_reconstruction_3D")

s = Plots.scatter(X_PCA[1,:],X_PCA[2,:], marker=:circle,linewidth=0, title="PCA reconstruction from the first 2 PCs")
#scatter!(versicolor[1,:],versicolor[2,:],versicolor[3,:],marker=:circle,linewidth=0)
#scatter!(virginica[1,:],virginica[2,:],virginica[3,:],marker=:circle,linewidth=0)
Plots.plot!(s,xlabel="PC1",ylabel="PC2", legend=false)
#PyPlot.title("PCA projection onto the first 3 PCs")
savefig("PCA_reconstruction_2D")
...
#scatter!(versicolor[1,:],versicolor[2,:],versicolor[3,:],marker=:circle,linewidth=0)
#scatter!(virginica[1,:],virginica[2,:],virginica[3,:],marker=:circle,linewidth=0)
Plots.plot!(t,xlabel="PC1",ylabel="PC2",zlabel="PC3", legend=false)
#PyPlot.title("PCA projection onto the first 3 PCs")
savefig("PCA_rotation_3D")
